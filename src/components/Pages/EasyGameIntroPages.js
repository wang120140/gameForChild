            ...
            (() => {
                ...
                switch (Garbage.getGarBage("position")) {
                    ...
                    case 3:
                        ...
                        this.ChineseTextX = [350, 360, 360, 350, 330];
                        ...
                        this.RecyclableWasteTextX = [280, 310, 310, 300, 280];
                        this.RecyclableWasteTextY = [738, 738, 738, 738, 738];
                        this.contentText = "除上述几类垃圾之外的砖瓦陶瓷、渣土、卫\n生纸等等。"
